...
import com.example.datastructor.Sort.Bubble_Sort;
...
public class Feibonaci_Search {
     ...
     */
    public static int feibonaciSearch(int[] a, int key) {
        int low, mid, high, k;
        low = 0;
        high = a.length - 1;
        // 斐波那契数列下标
    ...
    public void test() {
        ...
        while (iterator.hasNext()) {
            iterator.forEachRemaining(System.out::print);   //lambda
        }
    }
}
